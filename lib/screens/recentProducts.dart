                  ...
                  children: [
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: ClipRRect(
                          ...
                          child:
                              Image.network(productProvider.products[index].images[0], height: 10, width: 150, fit: BoxFit.cover),
                        ),
                      ),
                    ),
                    SizedBox(width: 10),
                    Row(
                      children: [
                        ...
                        CustomText(fontWeight: FontWeight.bold,color: orange,
                    ...
                    //     children: <Widget>[
                    //       Expanded(child: Icon(Icons.location_on, size: 14, color: grey)),
                    //       Expanded(
                    //         child: Container(
                    //           width: MediaQuery.of(context).size.width,
                    //           child: CustomText(text: '${productProvider.products[index].quantity}'),
                    //         ),
                    //       ),
                    //     ],
                    //   ),
